...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "V:[redButton]-30-[blueButton]-30-[greenButton]", options: NSLayoutConstraint.FormatOptions(), metrics: nil, views: viewsDict)
